...
def sound_event_detection(args):
    ...
    #model = get_basic_model(modelpath = "/home/super/yuhw/passt_hyonj/output/fsd50k/_None/checkpoints/epoch=49-step=153349.ckpt", mode="logits")
    model = get_basic_model(modelpath = "/home/super/yuhw/passt_hyonj/output/fsd50k/_None/checkpoints/epoch=49-step=153349.ckpt", mode="logits")
    ...
    with torch.no_grad():
        ...
        framewise_output, time_stamps = get_timestamp_embeddings(audio, model)
